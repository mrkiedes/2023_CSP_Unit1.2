##############################################################################
#   a123_TR_apple_typing_6.py
#   Run code in VS Code to be able to access the images.
#   Example soulution:
#      Code connects to the image of an apple.
#      A few apples are located on the image of a tree.
#      The apple does not draw a line as it falls.
#      The apple and letter disappears when the correct letter key is pressed.
#      When one disappears, a new apple and letter appear
#      The process repeats.
##############################################################################
